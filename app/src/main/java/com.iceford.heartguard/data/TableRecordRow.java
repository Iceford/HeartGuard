...
public class TableRecordRow {
    ...
    public TableRecordRow(String measureTime, String duration, int minHR, double avgHR, int maxHR, double avgHRV, double avgQTC, double avgSTRESS) {
    ...
    public String getMeasureTime() {
        return timestampToBeijingTime(Long.parseLong(measureTime));
    }
