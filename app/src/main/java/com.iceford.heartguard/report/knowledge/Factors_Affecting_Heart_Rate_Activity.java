...
public class Factors_Affecting_Heart_Rate_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_factors_affecting_heart_rate);
        ...
        webView.loadUrl("file:///android_asset/factors_affecting_heart_rate.html");
    }
}