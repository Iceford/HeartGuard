...
public class What_Is_Heart_Rate_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_what_is_heart_rate);
        ...
        webView.loadUrl("file:///android_asset/what_is_heart_rate.html");
    }
}
