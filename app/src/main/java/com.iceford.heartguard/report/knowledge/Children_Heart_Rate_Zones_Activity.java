...
public class Children_Heart_Rate_Zones_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_children_heart_rate_zones);
        ...
        webView.loadUrl("file:///android_asset/children_heart_rate_zones.html");
    }
}
