...
public class High_Heart_Rate_Complications_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_high_heart_rate_complications);
        ...
        webView.loadUrl("file:///android_asset/high_heart_rate_complications.html");
    }
}
